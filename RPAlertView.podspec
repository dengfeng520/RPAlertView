#
#  Be sure to run `pod spec lint RPAlertView.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/dengfeng520/RPAlertView.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "RPAlertViewDemo/RPAlertView/*.{h,m}"
